...
ADMINS = (
    # ('zhangxu', 'your_email@example.com'),
)
...
bae={
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'oEqimDqISFnfaYTnCetd',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'YSbB7B6PQQRBFVfiQQagrIO7',
        'PASSWORD': 'dVFfHSdWkl77E5qTRhjDNY2R2nBo63fZ',
...
SECRET_KEY = '92c&1-8((g#rfzgugp+3g4-!+lvewx&(%f5p84*edoagb$&ky1'
